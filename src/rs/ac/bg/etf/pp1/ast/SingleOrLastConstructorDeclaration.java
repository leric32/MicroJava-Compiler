...
public class SingleOrLastConstructorDeclaration extends ConstructorDeclList {

    private ConstructorDecl ConstructorDecl;

    public SingleOrLastConstructorDeclaration (ConstructorDecl ConstructorDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleOrLastConstructorDeclaration(\n");
